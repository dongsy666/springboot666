...
/*        gc.setMapperName("%sMapper");
        ...
        //自定义包的路径
        pc.setParent("com.dsy");
        //pc.setModuleName("module");   //模块名称  设置后,会生成com.dsy.test.module,里面存放之前设置的mapper,entity
        pc.setEntity("entity");
        pc.setMapper("mapper");
        ...
        //表前缀设置  dsy_student
        //strategy.setTablePrefix(new String[]{"dsy_"});
        //包的命名规则，使用驼峰规则
